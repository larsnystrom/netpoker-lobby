	...
	public boolean removePlayerFromGame(String gameName, Player player){
		...
		if(game != null){
			if(game.getHost().equals(player)){
				System.out.println("St�nger ner spel");
				closeGame(game, player);
				state = true;
			}else{
				System.out.println("Tar bort spelare fr�n spel");
	...
	public Game findGame(String gameName){
		for(Game game: games){
			if(gameName.equals(game.getGamename())){
				System.out.println("Game att skapa: " + gameName + " game att j�mf�ra med: " + game.getGamename());
				return game;
			}
